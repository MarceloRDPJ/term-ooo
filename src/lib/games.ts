...
export const GAMES: GameDefinition[] = [
  ...
  },
  {
    ...
    description: 'Adivinhe o ninja de Naruto pela silhueta. Em breve.',
    category: 'atributos',
    difficulty: 3,
    thumbnail: '🖼️',
    enabled: false,
    path: '/play/narutodle-silhouette',
    hint: 'Reconhece o ninja pela silhueta. Em breve.',
  },
  {
    slug: 'narutodle-jutsu',
    title: 'PITACO Narutodle Jutsu',
    description: 'Adivinhe o ninja de Naruto pelo jutsu que ele usa. Em breve.',
    category: 'atributos',
    difficulty: 3,
    thumbnail: '✨',
    enabled: false,
    path: '/play/narutodle-jutsu',
    hint: 'Recebe o jutsu e adivinha o personagem. Em breve.',
  },
]
