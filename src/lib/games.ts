...
export const GAMES: GameDefinition[] = [
  ...
  },
  {
    ...
    description: 'Adivinhe o estado brasileiro pela silhueta. Em breve.',
    category: 'geografia',
    difficulty: 2,
    thumbnail: '🗺️',
    enabled: false,
  ...
  },
  {
    slug: 'pitaco-emoji',
    title: 'PITACO Emoji',
    description: 'Decifre o auditor pela combinacao de emojis. Em breve.',
    category: 'atributos',
    difficulty: 2,
    thumbnail: '😀',
    enabled: false,
  ...
  },
  {
    ...
    description: 'Adivinhe o campeao de League of Legends pela splash art.',
    category: 'atributos',
    difficulty: 2,
    thumbnail: '🎨',
    enabled: true,
    path: '/play/loldle-splash',
    hint: 'Visual do campeao por splash art oficial. A imagem clareia a cada tentativa.',
  },
  {
    slug: 'pokedle',
    title: 'Pokedle',
    description: 'Adivinhe o Pokemon pelos tipos, geracao, cor, habitat, formato e evolucao.',
    category: 'atributos',
    difficulty: 2,
    thumbnail: '⚡',
    enabled: true,
    path: '/play/pokedle',
    hint: 'Jogo diario estilo Pokedle Classic. 8 tentativas, 6 atributos, 1 Pokemon.',
  },
  {
    slug: 'loldle-emoji',
